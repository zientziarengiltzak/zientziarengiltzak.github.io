           ...
           <div class="container">
               <div class="row">
                   <div class="col-lg-8 col-lg-offset-2">
                       ...
                       <iframe width="640" height="360" src="https://www.youtube.com/embed/hJhHJUNB_-U" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                       </br>
                       <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>Itxi</button>
                   </div>
               </div>
           ...
           <div class="container">
               <div class="row">
                   <div class="col-lg-8 col-lg-offset-2">
                       ...
                       <iframe width="640" height="360" src="https://www.youtube.com/embed/ZxyAUesblPE" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                       </br>
                       <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i>Itxi</button>
                   </div>
               </div>
               ...
               <div class="row">
                   <div class="col-lg-8 col-lg-offset-2">
                       <div class="modal-body">
                           <div class="row">
                               <div class="col-md-4">
                                   <img src="img/hitzaldiak/apsaal.jpg" class="img-responsive" alt="">
                               </div>
                               <div class="col-md-8">
                                   <h3>La Palmako Erupzioa: Geologiarekiko Jakinmina Pizten Denean</h3>
                                   <h2  class="porfolio-izena"> Arturo Apraiz, Fernando Sarrionandia-Ibarra, Ainhoa Alonso</h2>
                               </div>
                           </div>
                           <div class="row">
                               <p class="text-justify text-muted">
